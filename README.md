...
### พิมพ์สดและใช้งานหลายหน้าต่าง

หากต้องการให้ข้อความทยอยปรากฏระหว่างพูด ให้หยุดบันทึกก่อน ปิด **Thai + English: local large-v3 — preview, then type**, เปิด **Automatic corrections** และเลือก **Correction: local whisper** เมื่อเตรียม runtime แล้ว Apple Speech จะพิมพ์สด และ Whisper จะฟังเสียงซ้ำเพื่อแก้คำตามหลัง ดู [ขั้นตอนตั้งค่า](docs/GETTING_STARTED.md#พิมพ์สดพร้อมให้-whisper-ฟังเสียงซ้ำ)

แต่ละรอบผูกกับแอปและหน้าต่างที่เริ่มพูด รองรับการแทรกผ่าน Accessibility และ clipboard fallback สำหรับช่องที่ให้ข้อมูล Accessibility ไม่ครบ ถ้าจะย้ายหน้าต่าง ให้หยุด เลือกช่องใหม่ แล้วเริ่มอีกครั้ง ผลที่ยังค้างจะไม่ตามไปพิมพ์ผิดหน้าต่าง หากยืนยันปลายทางไม่ได้ ใช้ **Copy last transcript** แทน ช่องรหัสผ่านและหน้าต่างที่ไม่รับการวางข้อความยังไม่รองรับ
